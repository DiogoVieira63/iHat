    ...
    <v-container v-if="active">
        <v-row justify="center">
            ...
            >
                ...
                />
                <circle
                    v-for="(point, index) in drawPoints"
                    :cx="point.x"
                    :cy="point.y"
                    r="3"
                    fill="red"
                ...
                <v-tooltip text="End Polygon">
                    <template v-slot:activator="{ props }">
                        <v-btn
                            ...
                            icon="mdi-plus"
                            value="endDraw"
                            :disabled="toggle != 'startDraw' || drawPoints.length < 3"
                        ></v-btn>
                    </template>
                </v-tooltip>
                <v-tooltip text="Delete Zone">
                    <template v-slot:activator="{ props }">
                        <v-btn
                            v-bind="props"
                            icon="mdi-delete"
