...
<template>
    <v-form @submit.prevent="submit">
        ...
        <v-file-input v-model="filesIfc" v-if="tipo == 'ifc'" label="Ficheiro .ifc" accept=".ifc" density="compact"></v-file-input>
        <v-file-input v-model="filesDxf" v-else multiple label="Ficheiros .dxf" accept=".dxf" density="compact" />
